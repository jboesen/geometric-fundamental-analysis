...
class TSDiffPool(nn.Module):
    ...
    def __init__(
        ...
        super(TSDiffPool, self).__init__()
    ...
    def loss(self, pred, label):
        ...
        loss -= 50 * torch.min(torch.mean(pred_variance), torch.full_like(pred_variance, torch.sqrt(4.203855440056107)))
        return loss